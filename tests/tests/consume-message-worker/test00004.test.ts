...
it('ConsumeMessageWorker: case 4', async () => {
  ...
  jest.mock('worker_threads', () => {
    return {
      ...
      workerData: `${__dirname}/../../common/message-handler-worker-unacks.js`,
    };
  });
  ...
  expect(mockParentPort.postMessage).toHaveBeenCalledWith({
    code: EWorkerThreadMessageCodeConsume.MESSAGE_PROCESSING_ERROR,
