[RedisSMQ Common Library](../../../README.md) / [Docs](../../README.md) / [API Reference](../README.md) / WorkerThreadFailureError

# Class: WorkerThreadFailureError

## Extends

- [`RedisSMQError`](RedisSMQError.md)\<\{ `code`: `number`; \}\>

## Constructors

### Constructor

> **new WorkerThreadFailureError**(...`args`): `WorkerThreadFailureError`

#### Parameters

##### args

...\[[`IRedisSMQErrorOptions`](../type-aliases/IRedisSMQErrorOptions.md)\<\{ `code`: `number`; \}\>\]
