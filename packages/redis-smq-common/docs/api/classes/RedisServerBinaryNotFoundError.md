...
> **new RedisServerBinaryNotFoundError**(...`args`): `RedisServerBinaryNotFoundError`
...
> **code**: `string` = `'RedisSMQ.RedisServer.BinaryNotFound'`

##### defaultMessage

> **defaultMessage**: `string` = `'A Redis server binary could not be found. Please set up Redis server first.'`
