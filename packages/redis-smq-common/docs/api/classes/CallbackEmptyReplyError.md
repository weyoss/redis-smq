...
> **new CallbackEmptyReplyError**(...`args`): `CallbackEmptyReplyError`
...
> **code**: `string` = `'RedisSMQ.Callback.EmptyReply'`

##### defaultMessage

> **defaultMessage**: `string` = `'Callback returned an empty reply. A reply is required.'`
