...
> **new CallbackInvalidReplyError**(...`args`): `CallbackInvalidReplyError`
...
> **code**: `string` = `'RedisSMQ.Callback.InvalidReply'`

##### defaultMessage

> **defaultMessage**: `string` = `'Callback returned an invalid reply.'`
