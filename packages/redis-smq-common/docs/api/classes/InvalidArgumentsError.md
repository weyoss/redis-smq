[RedisSMQ Common Library](../../../README.md) / [Docs](../../README.md) / [API Reference](../README.md) / InvalidArgumentsError
...
> **new InvalidArgumentsError**(...`args`): `InvalidArgumentsError`
...
> **code**: `string` = `'RedisSMQ.InvalidArguments'`

##### defaultMessage

> **defaultMessage**: `string` = `'Invalid arguments provided.'`
