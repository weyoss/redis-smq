...
> **new InstanceLockError**(...`args`): `InstanceLockError`
...
> **code**: `string` = `'RedisSMQ.RedisClient.InstanceLock.Failed'`

##### defaultMessage

> **defaultMessage**: `string` = `'Failed to acquire instance lock. Another operation may be running concurrently.'`
