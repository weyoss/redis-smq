...
import { PostApiV1NamespacesNsQueuesNameOperationalStateResumeBodyReason } from '@/api/model';
...
const {
  ...
  reasonEnum: PostApiV1NamespacesNsQueuesNameOperationalStateResumeBodyReason,
  defaultReason:
