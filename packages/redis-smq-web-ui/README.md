...
![RedisSMQ Web UI - Home](https://github.com/weyoss/redis-smq/tree/next/packages/redis-smq-web-ui/docs/screenshots/img01.png)
...
Typically consumed via the [RedisSMQ Web Server](https://github.com/weyoss/redis-smq/tree/next/packages/redis-smq-web-server/README.md). To set up everything with pre-release builds:
