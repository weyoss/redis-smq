...
import { ICliOptions, IConsolidateOptions } from './types/index.js';
import { consolidateChangelogFromFile } from './consolidate-from-file.js';

export function consolidateChangelogCommand(program: Command) {
  program
