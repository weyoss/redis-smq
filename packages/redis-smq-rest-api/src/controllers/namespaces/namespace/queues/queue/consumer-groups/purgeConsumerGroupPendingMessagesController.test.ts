...
import { PurgeConsumerGroupPendingMessagesControllerResponseDTO } from './PurgeConsumerGroupPendingMessagesControllerResponseDTO.js';
  ...
  it('HTTP 204 No Content', async () => {
    ...
    const response1: TResponse<PurgeConsumerGroupPendingMessagesControllerResponseDTO> =
      await request.delete(
        `/api/namespaces/${queue.ns}/queues/${queue.name}/consumer-groups/${consumerGroup1}/messages`,
      );
