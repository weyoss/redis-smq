...
describe('matchQueuesTopicXController', () => {
  it('HTTP 200 OK', async () => {
    ...
    const response1: TResponse<MatchQueuesTopicXControllerResponseDTO> =
      await request
        .get(
          `/api/v1/namespaces/${exchange.ns}/exchanges/topic/${exchange.name}/queues`,
        )
