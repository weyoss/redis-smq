...
The topic pattern configuration. Can be:
...
Callback function that receives the matching queues or an error
...
When the topic pattern is not a valid regular expression
