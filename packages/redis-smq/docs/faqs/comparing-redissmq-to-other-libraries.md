...
- **Observability and storage (optional)**
  - Optional storage for acknowledged and dead-lettered messages with retention policies. See [Message Storage](../message-storage.md).
...
Optional message storage targets near-term operational needs (acknowledged/dead-lettered retention windows) instead of 
...
- Message storage: [Message Storage](../message-storage.md)
